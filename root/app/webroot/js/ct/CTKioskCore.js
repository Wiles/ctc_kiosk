...
function uOpenHelp(){
  if(help_src){
    $('#uHelp').css('background-image', 'url(' + window.webroot + '"img/'+ctk.app.lang+'/help/help-'+help_src+'.png")').show();
  }
}
...
function uOpenModal(url){
  ...
  $('#uPopUp .uPopContent').css({'background':'url(' + window.webroot + '"img/loading.gif") no-repeat scroll 50% 75% #fff', 'height':'350px'}).html('');
