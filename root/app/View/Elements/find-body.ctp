<div id="page-find-body" class="content-page">
  <div class="search-step-title">Search tires by vehicle<span data-i18n="step" class="kk"> - Step </span>
    <span class="searchStepNumb">4<span data-i18n="of_de" class="kk"> of </span>5</span>
  </div>
  <div class="search-label">
    <span data-i18n="select_your_vec" class="kk">SELECT YOUR VEHICLE </span>BODY
  </div>
  <div id="body-container" class="find-page"></div>
